...
(async function preloadBackgroundImage() {
  try {
    const bgUrl = "/assets/dowod/legitka.webp";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  try {
    ...
    [
      ...
      { id: "display-numerlegitka", key: "numerlegitka", formatter: up },
      { id: "display-wydanielegitka", key: "wydanielegitka", formatter: formatDateDots },
      { id: "display-datalegitka", key: "datalegitka", formatter: formatDateDots },
    ...
    [
      ...
      { id: "display-dyrekszkola", key: "dyrekszkola", formatter: up },
      { id: "display-telszkola", key: "telszkola"},
      { id: "display-adresszkola", key: "adresszkola", formatter: up },
      { id: "display-nazwaszkola", key: "nazwaszkola", formatter: up },
    ].forEach(function (item) {
      setText(item.id, localStorage.getItem(item.key), {
        formatter: item.formatter,
